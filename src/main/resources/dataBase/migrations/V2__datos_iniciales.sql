...
insert into asignacion_medico (fecha_inicio,fecha_fin,codigo_hospital,documento_medico,codigo_ciudad,codigo_horario,estado) values
    ('2024-06-01','2024-06-07','HOS001','MED001','CIU001',1,true);
